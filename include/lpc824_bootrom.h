...
#ifndef __LPC824_BOOTROM_H_INCLUDED__
#define __LPC824_BOOTROM_H_INCLUDED__
...
typedef struct {
  ...
  const UARTD_API_T
      *pUARTD; /*!< USART driver API function table base address */
} LPC_ROM_API_T;

#define ROM_DRIVER_TABLE 0x1fff1ff8
#define ROM_DRIVER_BASE (0x1FFF1FF8UL)

#endif // __LPC824_BOOTROM_H_INCLUDED__
